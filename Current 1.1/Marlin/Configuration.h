...
//#define DELTA
  ...
  // Adjustments to DELTA_DIAGONAL_ROD in the firmware control the size of the printed object.
  // Decrease DELTA_DIAGONAL_ROD value to increase object size
  // Increase DELTA_DIAGONAL_ROD value to decrease object size
  #define DELTA_DIAGONAL_ROD 216 // 207 mm  real measurement  // here _ks_
  // 207 = 156.2 
  // 208 = 100 + 6
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 139.4 //mm // here _ks_
  // 134 0.95 calibrated
  // 136.5 0.18 cal
  // 136.6 0.13 cal
  
  // 138 -0.5 calibrated// mm
  // 139.5 = -9
  // 140 = -8
  // 143 = 
  ...
  #define DELTA_EFFECTOR_OFFSET 28.8 //33.0 // mm  // here _ks_
// 28.8 = 120
// 28.7 =120
// 28.6 = 120
  ...
  #define DELTA_HEIGHT 100.85 // get this value from auto calibrate - use G33 C-1 at 1st time calibration
 ...
 */
 #define XYZ_FULL_STEPS_PER_ROTATION 200 // here _ks_   //189.5 100 movement in all direction are calibrated, but Z is not
 #define XYZ_MICROSTEPS 32
 #define XYZ_BELT_PITCH 2
 #define XYZ_PULLEY_TEETH 20
 #define XYZ_STEPS (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
 #define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 200} // Here
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 400, 30 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {200,200,200,4000}
...
#define XY_PROBE_SPEED 4000 //4000
...
#define HOMING_FEEDRATE_Z  4000 //(200*60)
