 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1500, 200 }
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //ks=//
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 60  //30
  #define RIGHT_PROBE_BED_POSITION 200 //200
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 200//((X_MIN_POS + X_MAX_POS) / 2)    // X point for Z homing when homing all axis (G28).
